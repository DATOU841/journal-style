...
文衡协议细节见 `docs/wenheng-native-protocol.md`；handoff 字段见 `templates/wenheng-handoff-schema.json`。运行入口见 `scripts/journal-style-startup.py`，该入口只生成文衡受控 handoff，不直接写 C03 source fields。
